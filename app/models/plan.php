	...
	//TODO faltaria hacer el test de esto
  	...
  	function dameListadoOfertasPorInstitucion($instit_id,$ciclo_id = 0){
  		...
  		$vec = $this->Anio->find('all',array(
  					...
  					'group'=>'"Plan"."id", "Plan"."instit_id", "Plan"."oferta_id", "Plan"."old_item", "Plan"."norma", "Plan"."nombre", "Plan"."perfil", "Plan"."duracion_hs", "Plan"."duracion_semanas", "Plan"."duracion_anios", "Plan"."matricula", "Plan"."observacion", "Plan"."ciclo_alta", "Plan"."ciclo_mod", "Plan"."created", "Plan"."modified", "Plan"."titulo_id"',
