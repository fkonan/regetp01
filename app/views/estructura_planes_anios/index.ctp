...
?>
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $estructuraPlanesAnio['EstructuraPlanesAnio']['trayecto_id']; ?>
		</td>
		<td>
			<?php echo $estructuraPlanesAnio['EstructuraPlanesAnio']['edad_teorica']; ?>
		</td>
		<td>
			<?php echo $estructuraPlanesAnio['EstructuraPlanesAnio']['anio']; ?>
		</td>
		<td>
			<?php echo $estructuraPlanesAnio['EstructuraPlanesAnio']['anio_escolaridad']; ?>
		</td>
		<td>
			<?php echo $estructuraPlanesAnio['EstructuraPlanesAnio']['created']; ?>
		</td>
		<td>
			<?php echo $estructuraPlanesAnio['EstructuraPlanesAnio']['modified']; ?>
		</td>
		<td class="actions">
