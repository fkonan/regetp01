<SCRIPT language=javascript>
        ...
        function setCuadro(ProvName, id) {
...
name=m_mapa_argentina>
    <area
  onMouseOver="javascript:setCuadro('Cdad. de Buenos Aires',3);"
  title="Ciudad Autónoma de Buenos Aires"
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 2)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Tierra del Fuego',24);"
  title="Tierra del Fuego" onMouseOut="javascript:setCuadro('',-1);" shape=POLY
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 94)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Santa Cruz',21);" title="Santa Cruz"
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt="Santa Cruz"
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 78)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Chubut',5);" title=Chubut
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt=Chubut
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 26)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Rio Negro',17);" title="Rio Negro"
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt="Rio Negro"
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 62)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Neuquén',15);" title=Neuquén
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt=Neuquén
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 58)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Mendoza',13);" title=Mendoza
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt=Mendoza
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 50)) ?>">
    <area
  onMouseOver="javascript:setCuadro('La Pampa',11);" title="La Pampa"
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt="La Pampa"
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 42)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Pcia.de Buenos Aires(La Plata)',1);" title="Buenos Aires"
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt="Buenos Aires"
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 6)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Entre Ríos',8);" title="Entre Ríos"
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt="Entre Ríos"
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 30)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Misiones',14);" title=Misiones
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt=Misiones
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 54)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Corrientes',7);" title=Corrientes
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt=Corrientes
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 18)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Santa Fe',22);" title="Santa Fe"
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt="Santa Fe"
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 82)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Córdoba',6);" title=Córdoba
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt=Córdoba
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 14)) ?>">
    <area
  onMouseOver="javascript:setCuadro('San Luis',20);" title="San Luis"
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt="San Luis"
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 74)) ?>">
    <area
  onMouseOver="javascript:setCuadro('San Juan',19);" title="San Juan"
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt="San Juan"
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 70)) ?>">
    <area
  onMouseOver="javascript:setCuadro('La Rioja',12);" title="La Rioja"
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt="La Rioja"
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 46)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Santiago del Estero',23);"
  title="Santiago del Estero" onMouseOut="javascript:setCuadro('',-1);"
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 86)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Catamarca',2);" title=Catamarca
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt=Catamarca
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 10)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Tucumán',25);" title=Tucumán
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt=Tucumán
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 90)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Chaco',4);" title=Chaco
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt=Chaco
  coords=217,93,233,71,287,116,280,133,240,134,241,94
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 22)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Formosa',9);" title=Formosa
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt=Formosa
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 34)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Salta',18);" title=Salta
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt=Salta
  ...
  href="<?php echo $html->url(array('controller'=>'jurisdicciones','action'=>'view', 66)) ?>">
    <area
  onMouseOver="javascript:setCuadro('Jujuy',10);" title=Jujuy
  onMouseOut="javascript:setCuadro('',-1);" shape=POLY alt=Jujuy
