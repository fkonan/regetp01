...
<?php 
    ...
    $descripcionPlural = "Se presenta información sobre %u Planes de Mejora juridiccionales aprobados por un total de $%s. <br/>" .
                         "Período: 2006-Septiembre de 2011. <br/>".
            ...
            <div class="tabs-content">
                ...
                ?>
                    <div id="notas" style="font-size:8pt; font-style: italic; margin-bottom: 30px">
                        ...
                        <ul>
                            <li>
                                La información publicada corresponde a Planes de Mejora aprobados desde el año 2006 a Septiembre de 2011 inclusive. La información será actualizada periódicamente.
                            </li>
                            <li>
