            ...
            <div class="tabs-content">
                ...
                ?>
                    <div id="notas" style="font-size:8pt; font-style: italic; padding-top: 30px; margin-bottom: 30px">
                        ...
                        <ul>
                            <li>
                                La información publicada corresponde a Planes de Mejora aprobados desde el año 2006 a Junio de 2011 inclusive. La información será actualizada periódicamente.
                            </li>
                            <li>
