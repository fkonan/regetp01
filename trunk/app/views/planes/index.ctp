                                    ...
                                    <div id="fragment-<?php echo $oferta?>" class="fragment">
                                        <div class="vertical-tabs">
                                            <ul>
                                                    ...
                                                    <li><a href="<?php echo $html->url(array('controller'=>'planes', 'action'=>$ofertasControllers[$oferta], 'instit_id'=>$planes['Instit']['id'], 'ciclo'=>$anio));?>"><span><?php echo $anio?></span></a></li>
                                                    <?php } ?>
                                            </ul>
                                        </div>
                                    </div>
