...
<?php echo $form->create('Trayecto', array('onsubmit'=>'return EtapasASubmit();'));?>
	<fieldset>
 		<legend><?php __('Edit Trayecto');?></legend>
	<?php
		echo $form->input('id');
	...
	?>
        ...
        <?php
            ...
            echo $form->input('anio', array('id'=>'anio', 'label'=>'Año', 'maxlength'=>2, 'size'=>2, 'style'=>'width: 18px;', 'div' => false));
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('Trayecto.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Trayecto.id'))); ?></li>
