...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit Jurisdiccion', true), array('action'=>'edit', $jurisdiccion['Jurisdiccion']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete Jurisdiccion', true), array('action'=>'delete', $jurisdiccion['Jurisdiccion']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $jurisdiccion['Jurisdiccion']['id'])); ?> </li>
...
<div class="related">
	<h3><?php __('Related Tipoinstits');?></h3>
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $html->link(__('View', true), array('controller'=> 'tipoinstits', 'action'=>'view', $tipoinstit['id'])); ?>
				<?php echo $html->link(__('Edit', true), array('controller'=> 'tipoinstits', 'action'=>'edit', $tipoinstit['id'])); ?>
				<?php echo $html->link(__('Delete', true), array('controller'=> 'tipoinstits', 'action'=>'delete', $tipoinstit['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $tipoinstit['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
