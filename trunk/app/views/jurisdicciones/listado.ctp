...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        jQuery('#m_mapa_argentina area').mouseover(function(){
            jQuery('#provincia-name').html(this.title);
            jQuery(document).mousemove(function(e){
                jQuery('#provincia-name').css({'top':(e.pageY-5)});
            });
        });
    });
</script>
...
<div class="jurisdicciones index">
    ...
    <div style="float: right; clear: left; margin-right: 100px">
        <?php
        ...
        <map id=m_mapa_argentina name=m_mapa_argentina>
            ...
            <area
                title="Pcia.de Buenos Aires"
                shape=POLY alt="Buenos Aires"
