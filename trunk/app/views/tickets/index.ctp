...
<h2><?php __('Pendientes de Actualizaci�n. Jurisdicci�n: ' . $jurisdiccion_name);?></h2>
<p  class="paginate_msg">
	<?php
	echo $paginator->counter(array(
	'format' => __('P�gina %page% de %pages%<br />Mostrando %current% registros de %count% encontrados, visualizando registros desde el n� %start%, hasta el %end%', true)
	));
	?>
</p>
...
<tr>
	<th><?php echo $paginator->sort('Fecha Creaci�n','Ticket.created');?></th>
