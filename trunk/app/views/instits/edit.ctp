...
<?php echo $form->create('Instit');?>
	<fieldset>
 		<legend><?php __('Editar Institución');?></legend>
	<?php
		echo $form->input('id');		
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('Instit.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Instit.id'))); ?></li>
