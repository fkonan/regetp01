    ...
    <div class="boxblanca boxdocs">
        ...
        <div class="centrado">
            ...
            <div id="el_inet_graph">
                <a href="#txt_comision" id="graph_comision" onclick="return viewDescription(this)">Comisión Federal de Educación Técnico Profesional</a>
                <a href="#txt_consejo_federal" id="graph_consejo_federal" onclick="return  viewDescription(this)">Consejo Federal de Educación</a>
                <a href="#txt_consejo_nacional" id="graph_consejo_nacional" onclick="return  viewDescription(this)">Consejo Nacional de Educación Trabajo y Producción (CONETyP)</a>
                <a href="#txt_inet" id="graph_inet" onclick="return viewDescription(this)">Instituto Nacional de Educación Tecnológica</a>
                <a href="http://www.me.gov.ar/" target="_blank" id="graph_me">Ministerio de Educación</a>
            </div>
