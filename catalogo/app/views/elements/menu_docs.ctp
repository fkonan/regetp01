...
?>
<h1 class="grid_12 no-print">Documentaci&oacute;n</h1>
	    ...
	    <ul>    
	        <li>
	            ...
	            <ul>
	                ...
	                <li><?php echo $html->link('Textil / Indumentaria', array('controller' => 'pages', 'action' => 'display', 'sectores/textil_indumentaria'));?></li>
	            </ul>
	        </li>
	    </ul>
    </div>
