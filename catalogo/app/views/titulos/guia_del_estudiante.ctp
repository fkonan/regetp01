<?php echo $javascript->link('jquery/jquery.tmpl.min', false); ?> <?php echo
$javascript->link('jquery/jquery.history', false); ?> <?php echo
$javascript->link('jquery.loadmask.min', false); ?> <?php echo
$html->css(array('jquery.loadmask',
                            'catalogo.guia_del_estudiante'), $inline = false); ?>

<h1>Guía del Estudiante</h1> <div class="clear" style="height:20px;"></div>
...
<div id="resultados" class="grid_12">
    <div id="li_titulos" class="grid_6 alpha boxgris">
        ...
        <ul class="seleccionados"></ul> <ul class="results">
            Sin Resultados
        </ul>
        <?php echo $form->end(); ?>
    </div>
