...
<div class="actions">
	<ul>
		...
		<li><?php echo $html->link(__('Delete Tipoinstit', true), array('action'=>'delete', $tipoinstit['Tipoinstit']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $tipoinstit['Tipoinstit']['id'])); ?> </li>
		<li><?php echo $html->link(__('List Tipoinstits', true), array('action'=>'index')); ?> </li>
		<li><?php echo $html->link(__('New Tipoinstit', true), array('action'=>'add')); ?> </li>
